...
includes:
  es:
    ...
    - "Equipo técnico grupal (cuerdas, estacas, protecciones de nieve)"
    - "Transporte desde Santiago (punto de encuentro)"
    - "Gestión de permisos"
    - "Manual técnico digital"
  en:
    - "Certified mountain guide"
    - "Group technical gear (ropes, pickets, snow protection)"
    - "Transport from Santiago (meeting point)"
    - "Permit management"
    - "Digital technical manual"
excludes:
  es:
    - "Equipo personal (botas plásticas/híbridas, piolet, crampones, arnés, casco)"
    - "Alimentación durante los 4 días"
    - "Seguro de accidentes/rescate"
  en:
    - "Personal gear (double/hybrid boots, ice axe, crampons, harness, helmet)"
    - "Meals for the 4 days"
    - "Accident/rescue insurance"
itinerary:
  - day: 1
    title:
      es: "Logística y Aproximación"
      en: "Logistics and Approach"
    body:
      es: "Encuentro en Santiago, revisión de equipo personal y traslado al Cajón del Maipo. Aproximación y establecimiento del campamento base cerca del margen glaciar."
      en: "Meeting in Santiago, personal gear check and transfer to Cajón del Maipo. Approach and base camp setup near the glacier margin."
  - day: 2
    title:
